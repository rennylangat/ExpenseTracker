...
public abstract class HmsInstallReferrer {
    ...
    public static HmsInstallReferrer getReferrerForId(Integer id) {
        return allReferrers.get(id);
    }

    public static InstallReferrerSdkUtil createSdkReferrer(Integer id, Context context, MethodChannel channel) {
        HmsInstallReferrer referrer = getReferrerForId(id);
