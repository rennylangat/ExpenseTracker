...
public class ResourceUtil {
    ...
    public static int getStringResourceIdFromContext(@NonNull Context context, String resName) {
        ...
        if (stringRes == 0) {
            Log.e(TAG, String.format(Locale.ENGLISH, "The 'R.string.%s' value it's not defined in your project's resources file.", resName));
        }
    ...
    public static int getLogoResourceIdFromContext(@NonNull Context context, String resName) {
        ...
        if (mipmapResId == 0 && drawableResId == 0) {
            Log.e(TAG, String.format(Locale.ENGLISH, "The 'R.mipmap.%s' or 'R.drawable.%s' value it's not defined in your project's resources file.", resName, resName));
        }
