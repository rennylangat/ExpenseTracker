...
class BannerAdSize extends AdSize {
  ...
  Future <int> get getWidthPx async {
    return Ads.instance.channel.invokeMethod("bannerSize-getWidthPx", super.toJson());
  }
  Future <int> get getHeightPx async {
    return Ads.instance.channel.invokeMethod("bannerSize-getHeightPx", super.toJson());
  }
  ...
  static Future <BannerAdSize> getCurrentDirectionBannerSize(int width) async {
    ...
    Map<dynamic, dynamic> bannerJson = await  Ads.instance.channel.invokeMethod("getCurrentDirectionBannerSize", json);
  ...
  static Future <BannerAdSize> getLandscapeBannerSize(int width) async {
    final Map<String, dynamic> json = <String, dynamic>{};
    if (width != null) json['width'] = width;
    Map<dynamic, dynamic> bannerJson = await Ads.instance.channel.invokeMethod("getLandscapeBannerSize", json);
    return fromJson(bannerJson);
  }
  ...
  static Future <BannerAdSize> getPortraitBannerSize(int width) async {
    final Map<String, dynamic> json = <String, dynamic>{};
    if (width != null) json['width'] = width;
    Map<dynamic, dynamic> bannerJson = await Ads.instance.channel.invokeMethod("getPortraitBannerSize", json);
    return fromJson(bannerJson);
  }
