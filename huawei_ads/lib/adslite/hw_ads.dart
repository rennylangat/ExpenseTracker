...
class HwAds {
  ...
  static Future<String> get getSdkVersion async {
    String sdkVersion = await Ads.instance.channel.invokeMethod('HwAds-getSdkVersion');
    return sdkVersion;
  }
  ...
  static Future<bool> setRequestOptions(RequestOptions options) async {
    bool result = await Ads.instance.invokeBooleanMethod('HwAds-setRequestOptions', options.toJson());
    return result;
  }
}