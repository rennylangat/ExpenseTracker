...
class VideoOperator {
  ...
  set setVideoLifecycleListener(VideoLifecycleListener listener) => _listener = listener;
  ...
  Future<bool> isCustomizeOperateEnabled() async {
    ...
    bool customEnabled = await _nativeChannel.invokeMethod("isCustomOperateEnabled");
  ...
  Future<bool> mute(bool mute) async {
    ...
    bool muted = await _nativeChannel.invokeMethod("mute", {
      "mute": mute
    });
    return muted;
  }
