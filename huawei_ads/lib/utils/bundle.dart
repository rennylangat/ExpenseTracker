...
class Bundle{
  ...
  void putString (String key, String s) => _bundle[key] = {"type":_string, "val":s};
  void putStringArrayList (String key, List<String> arr) => _bundle[key] = {"type": _stringList, "val": arr};
